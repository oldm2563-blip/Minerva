...
<head>
    ...
    <title>Ajouter un étudiant - Enseignant</title>
...
<body>
    <div class="app-container">
        ...
        <main class="main-content">
            ...
            <div class="content-section">
                <h2 class="section-title">Créer un compte étudiant</h2>
                ...
                <form action="/teacher/addstudent" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" placeholder="jean.dupont@email.com" required>
                    </div>
    ...
    <script>
        document.querySelector('input[name="generate_password"]').addEventListener('change', function() {
