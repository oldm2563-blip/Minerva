...
<head>
    ...
    <title>Travaux - Enseignant</title>
        ...
        <main class="main-content">
            ...
            <div class="content-section">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <h2 class="section-title">Créer un nouveau travail</h2>
                </div>
                
                <form action="/teacher/work" method="POST" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="form-group">
                            <label class="form-label">Titre du travail</label>
                            <input type="text" class="form-control" name="name" placeholder="Ex: Devoir maison n°3" required>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" placeholder="Description détaillée du travail..." rows="4" required></textarea>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="filepath" placeholder="Chemin du fichier">
                        </div>
                    </div>
            ...
            <div class="content-section">
                <h2 class="section-title">Travaux existants</h2>
                            ...
                            <?php if (isset($works) && !empty($works)): ?>
                                <?php foreach ($works as $work): ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($work['class_name'] ?? 'Non spécifiée') ?></td>
                                        <td><?= htmlspecialchars($work['due_date'] ?? '') ?></td>
                                        <td>
                                            <?php 
                                            ...
                                            ?>
                                            <span class="badge badge-<?= $status == 'Terminé' ? 'success' : ($status == 'Aujourd\'hui' ? 'warning' : 'primary') ?>">
                                ...
                                <tr>
                                    <td colspan="5" style="text-align: center; padding: 40px;">
                                        <div class="alert alert-info" style="margin-bottom: 0;">
                                            Aucun travail créé. <a href="/teacher/works#create-work" class="btn btn-sm">Créer votre premier travail</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
