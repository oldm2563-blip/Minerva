            ...
            <div class="content-section">
                ...
                <div class="stats-grid">
                    <div class="stats-card">
                        ...
                        <div class="stats-number"><?php echo $statistics['average_grade'] ?? 0; ?>/20</div>
                        <div class="stats-label">Notes</div>
                    </div>
                    
                    <div class="stats-card">
                        <h3>Étudiants</h3>
                        <div class="stats-number"><?php echo $statistics['total_students'] ?? 0; ?></div>
                        <div class="stats-label">Total</div>
                    </div>
                    
                    <div class="stats-card">
                        <h3>Taux de présence</h3>
                        <div class="stats-number"><?php echo $statistics['attendance_rate'] ?? 0; ?>%</div>
                        <div class="stats-label">Présence</div>
                    </div>
                    
                    <div class="stats-card">
                        <h3>À évaluer</h3>
                        <div class="stats-number"><?php echo $statistics['pending_assignments'] ?? 0; ?></div>
                        <div class="stats-label">Travaux</div>
                    </div>
                </div>
            </div>
